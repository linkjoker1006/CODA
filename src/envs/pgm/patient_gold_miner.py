...
class PGM(gym.Env):
    ...
    def __init__(self, grid_shape: Coordinates = (8, 9), n_agents: int = 3, n_golds: int = 1,
                 ...
                 max_steps: int = 25, seed: int = None):
        ...
        self._obs_len = int(2 + 1 + 3 * mask_size)
    ...
    def step(self, agents_action: List[int]):
        ...
        #     self.agents_mining_gold = 0
        #     self.agents_mining_stone = 0
        #     self.agents_doing_nothing = 0
        
        # agents_mining_gold = 0
        # agents_mining_stone = 0
        # agents_doing_nothing = 0

        # # 遍历所有智能体，检查它们当前位置的资源
        # for agent in self._agents:
        #     pos = agent.pos
        #     # 检查智能体是否在金矿上
        #     if self._gold_map[pos] > 0:
        #         agents_mining_gold += 1
        #     # 检查智能体是否在石头上 (使用 elif 避免重复计数)
        #     elif self._stone_map[pos] > 0:
        #         agents_mining_stone += 1
        
        # # 计算什么都没挖的智能体数量
        # agents_doing_nothing = self.n_agents - agents_mining_gold - agents_mining_stone
        
        # self.agents_mining_gold += agents_mining_gold
        # self.agents_mining_stone += agents_mining_stone
        # self.agents_doing_nothing += agents_doing_nothing

        # # 创建并填充 info 字典
        # info = {
        #     'test_info': [self.agents_mining_gold, self.agents_mining_stone, self.agents_doing_nothing]
        # }
        # ==================== 测试添加代码 ====================
