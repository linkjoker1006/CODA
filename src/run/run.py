...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        "ask_actions": {"vshape": (1,), "group": "agents", "dtype": th.long},
        "advice_actions": {"vshape": (1,), "group": "agents", "dtype": th.long},
        "chosen_actions": {"vshape": (1,), "group": "agents", "dtype": th.long},
    ...
    if args.checkpoint_path != "":
        ...
        # model_path = os.path.join(args.checkpoint_path, str(timestep_to_load))  # 直接加载最大时间戳的模型
        
        timestep_to_load = int(args.checkpoint_path.split('/')[-1])
        model_path = args.checkpoint_path  # 直接加载
